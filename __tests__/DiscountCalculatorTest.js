...
describe('DiscountCalculator에 대한 Test', () => {
  ...
  describe('calculateChristmasDDayDiscount', () => {
    it('크리스마스 디데이 기간이 아닌 경우 할인이 적용되지 않아야 한다.', () => {
      ...
      // When
      const discountCalculator = createDiscountCalculator(visitDate, orderDetails);
    ...
    it('크리스마스 디데이 기간인 경우 할인이 정확히 계산되어야 한다.', () => {
      // Given
      const visitDate = 25;
      const orderDetails = ['티본스테이크 1개', '바비큐립 1개'];
  ...
  describe('calculateWeekdayDiscount', () => {
    it('평일이고 디저트를 주문하지 않은 경우 할인이 적용되지 않아야 한다.', () => {
      // Given
      const visitDate = 3;
      const orderDetails = ['티본스테이크 1개', '레드와인 2개'];
    ...
    it('평일이고 디저트를 주문한 경우 디저트 메뉴를 1개당 할인이 적용된다.', () => {
      // Given
      const visitDate = 7;
      const orderDetails = ['티본스테이크 1개', '초코케이크 2개'];
  ...
  describe('calculateWeekdendDiscount', () => {
    it('주말이고 메인메뉴를 주문하지 않은 경우 할인이 적용되지 않는다.', () => {
      // Given
      const visitDate = 1;
      const orderDetails = ['시저샐러드 1개', '제로콜라 2개'];
    ...
    it('주말이고 메인메뉴를 주문한 경우 개당 할인이 적용된다.', () => {
      // Given
      const visitDate = 9;
      const orderDetails = ['시저샐러드 1개', '바비큐립 2개'];
  ...
  describe('calculateDiscounts', () => {
    it('각 할인이 정확히 계산되어 총 할인 금액이 올바르게 설정되어야 한다.', () => {
      // Given
      const visitDate = 25;
      const orderDetails = ['티본스테이크 1개', '레드와인 2개', '초코케이크 3개'];
